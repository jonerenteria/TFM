...
ggplot(data.oxt.plot.oxtpost, aes(x=predictor,y=value)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/OXT_post.png"), last_plot(),width = 3.5, height = 3.5,"png")
...
ggplot(data.oxt.plot, aes(x=predictor,y=value, fill=stimulus.type)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/stimulus.change1.png"), last_plot(),width = 6, height = 3.5,"png")
```
...
ggplot(data.oxt.plot.age, aes(x=predictor,y=value)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/EdadOXT.png"), last_plot(),width = 3.5, height = 3.5,"png")
```
