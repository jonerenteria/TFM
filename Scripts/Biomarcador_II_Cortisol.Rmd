...
ggplot(data.co.plot.copost, aes(x=predictor,y=value)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/Co_post_general.png"), last_plot(),width = 3.5, height = 3.5,"png")
```
...
ggplot(cat.co, aes( x=variable, y=obs, fill=factor)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/co_predictors_general.png"), last_plot(),width = 6, height = 3.5,"png")
```
...
ggplot(data.co.plot, aes(x=predictor,y=value, fill=stimulus.type)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/predictors_general_onebyone.png"), last_plot(),width = 3.5, height = 3.5,"png")
...
ggplot(data.co.plot.age, aes(x=predictor,y=value, fill=stimulus.type)) +
 ...
 stat_summary(fun.y=max,position=position_dodge(.9), colour="gray25", geom="text", show_guide = FALSE, hjust=-1.5, vjust=-0.55, aes( label=round(..y.., digits=2)),size=2.5)+
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/Co_age_general.png"), last_plot(),width = 6, height = 3.5,"png")
...
ggplot(data.co.plot.copost.sngr, aes(x=predictor,y=value)) +
  ...
  labs(y="Nivel de cortisol tras el estímulo (pg/ml)") +
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/CO_post_sangre.png"), last_plot(),width = 3.5, height = 3.5,"png")
```
...
ggplot(data.co.plot.sngr, aes(x=predictor,y=value)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/CO_predictores_sangre.png"), last_plot(),width = 3.5, height = 3.5,"png")
```
...
ggplot(data.co.plot.copost.slv, aes(x=predictor,y=value)) +
  ...
  labs(y="Nivel de cortisol tras el estímulo (pg/ml)") +
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/CO_post_saliva.png"), last_plot(),width = 3.50, height = 3.5,"png")
```
...
ggplot(data.co.plot.slv, aes(x=predictor,y=value, fill=stimulus.type)) +
  ...
  ggsave(filename = paste0(getwd(),"/Scripts/Figures/CO_preditors_saliva.png"), last_plot(),width = 6, height = 3.5,"png")
```
